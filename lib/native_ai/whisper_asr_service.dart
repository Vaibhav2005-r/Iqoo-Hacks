...
///
/// This file is the TEMPLATE. scripts/enable_native_ai.sh copies it to
/// lib/native_ai/, and that copy is what actually compiles — so edit this one
/// and re-run the script, never the copy, or your change will be overwritten
/// the next time anyone toggles native AI.
///
